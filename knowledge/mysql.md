...
![XA第一阶段](https://gitee.com/zongl/cloudImage/raw/master/images/2021/03/01/XA-first.jpg)
...
3、如果本地事务执行成功，则向mq发送一条confirm消息，如果发送失败，则发送回滚消息
...
周期性检查group是否处于阻塞状态，当出现阻塞时，会通过唤醒线程或新建线程来解决。
